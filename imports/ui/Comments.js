            ...
            <div className="media">
                <a className="pull-left" href="#paper-kit">
                    <div className="avatar">
                        <img className="media-object" alt={this.props.comment.userName + " picture"}
                             src={this.props.comment.userPic}/>
                    </div>
                </a>
                <div className="media-body">
                    ...
                    <div className="pull-right">
                        ...
                        <a href="#paper-kit" className="btn btn-info btn-link pull-right">
                            <i
