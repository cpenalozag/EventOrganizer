            ...
            <Router>
                <div>
                            ...
                            <div className="container">
                                ...
                                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul className="navbar-nav ml-auto">
                                        ...
                                        {this.props.currentUser ?
                                            <li className="nav-item">
                                                <NavLink exact className="nav-link" to="/notifications"><div className="icon icon-danger">
                    ...
                    <Route exact path="/events"
                           render={() => <EventList eventsList={this.props.eventsList} loadMore={this.props.loadMore}
                                                    page={1} userEvents={this.props.userEvents}
                    ...
                    <Route exact path="/notifications" render={() => <Notifications notifications={this.props.notifications}/>}/>
                    <Route exact path="/events/:eventId" component={EventDetail}/>
                    <Route exact path="/myEvents" render={() => <UserEventList userEvents={this.props.eventsList}
